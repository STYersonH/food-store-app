...
const CartContainer = () => {
  ...
  return (
    // z-[101] hace que el contenedor este por encima de todos los demas
    <motion.div
    ...
    >
      ...
      {cartItems && cartItems.length > 0 ? (
        <div className=" w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
          {/* Cart Items section*/}
          <div className=" w-full h-[450px] md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
            {/* cart item*/}
            {cartItems &&
              cartItems.map((item) => (
                <CartItem
